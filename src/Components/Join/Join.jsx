            ...
            <div className="app__join-wrapper">
                ...
                <div className="app__join-form">
                    <form action="" onSubmit={e => {
                        ...
                        <div className="app__join-form-wrapper">
                            <div onClick={() => { navigate('/welcome') }} className="app__logo-join">
                            ...
                            <h2 className='letsDoThis'>Let's do this</h2>
                            <Input color='success' type="text" name='name' placeholder='Name' required />
                            <Input color='success' type="email" name='email' placeholder='E-mail' required />
                            <Input color='success' type="username" name='username' placeholder='Username' required />
                            <Input color='success' type="password" name='password' placeholder='Password' required />
                            <p className='terms'>By creating an account, you accept our Terms.</p>
